import{d as l,a as i,b as r}from"./mainimage-g2-cBrXy.js";/* empty css              */import{r as c,F as m,W as u,l as g}from"./linko-NB29h-rl.js";import{d as f}from"./maindatakeywords-B6YbvK1q.js";Promise.all([l,i,f,r]).then(()=>{console.log("✅ All data loaded for aboutus page");const o=document.getElementById("app");o?(o.innerHTML=c(),(()=>{const s=document.getElementById("burger-btn"),d=document.getElementById("mobile-menu");s&&d&&s.addEventListener("click",()=>{d.classList.toggle("hidden")})})()):console.log("header not loading");const e=document.getElementById("fe");e?e.innerHTML=m():console.log("footer not loading");const t=document.getElementById("wave");t?t.innerHTML=u():console.log("wave not loading");const n=document.getElementById("dam");n&&(n.innerHTML=g());const a=document.getElementById("em");a&&(a.innerHTML=`
