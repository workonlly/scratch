...
if (firstid){
  ...
  <a href="../show.html?id=${items.id}" class="flex flex-col items-center gap-4 w-full no-underline">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-full p-1">
    ${gg
      .map((item) => {
        ...
        return `
          <a href="../show.html?id=${item.sid}" class="block bg-white/70 shadow-xl p-4 min-h-[200px] flex flex-col items-center text-center gap-4 rounded-2xl hover:scale-105 transition-transform duration-300 hover:border-2 hover:border-black w-full no-underline">
            <div class="rounded-full h-[60px] w-[60px] overflow-hidden">
